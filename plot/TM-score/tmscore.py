...
for cycle in cycles:
    ...
    all_data_excel = f"./CreoPep/plot/TM-score/tmscore_{cycle}.csv"
    ...
    tasks_name = ["AChBP","Ca22","a3b4","Na12","a3b2","a7","a9a10","a4b2"]
    ...
    fig.show()
    fig.write_image(f"./CreoPep/plot/TM-score/tmscore_{cycle}.png",scale=4)
