...
def CreoPep(X1, X2, τ, g_num, length_range, model_name, seed):
    if seed =='random':
...
if __name__ == '__main__':
    ...
    CreoPep(args.subtype, args.potency, args.temperature, args.num, args.begin, args.end, args.model, args.seed)
